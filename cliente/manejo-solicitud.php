<?php
    ...
    if(isset($_GET['cancela'])){
        ...
        mysqli_query($link,"delete from solicitudes where producto_solicitante=$producto_solicitado");
        //producto solicitante
        $solicitante=mysqli_query($link,"select id_user from productos where id_producto=$producto_solicitante");
        $row=mysqli_fetch_array($solicitante);
        $id_solicitante=$row['id_user'];
        ...
        mysqli_query($link,"delete from solicitudes where producto_solicitante=$producto_solicitante");
