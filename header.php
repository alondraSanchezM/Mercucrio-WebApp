<header class="align-content-start header">
    <div class="d-flex justify-content-between">
        ...
        <div class="boton-central-publicar align-items-center">
            <a class="boton-central-publicar-texto " href="login.php?u=1">
    ...
    function autocompletado () {
        ...
        for(let i=0;i< data.nombre.length ; i++){
            ...
            if (posicion !== -1)
                ...
                respuestas += "<li class='decoracions-buscador-li'><a class='buscador-head' href='login.php?id_p="+data.id_producto[i]+"'>"+data.nombre[i]+"</a></li>";
        }
